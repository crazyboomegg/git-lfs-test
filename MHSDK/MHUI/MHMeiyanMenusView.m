...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (![cell.menuModel.beautyTitle isEqualToString:@""]){
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //单击拍
    else if([currentModel.beautyTitle isEqual:@""]){
...
- (MHMakeUpView *)makeUpView {
    if (!_makeUpView) {
        _makeUpView = [[MHMakeUpView alloc] initWithFrame:CGRectMake(0, window_height-MHStickersViewHeight-BottomIndicatorHeight , window_width, MHStickersViewHeight)];
...
-(NSMutableArray *)array {
    if (!_array) {
        NSArray *arr = self.sdkLevelTYpe==0?@[@"貼紙",@"美颜",@"特效",@"哈哈鏡"]:@[@"貼紙",@"美颜",@"美妆",@"特效"];
        NSArray *imgArr =self.sdkLevelTYpe==0? @[StickerImg,BeautyImg,SpecificImg,HahaImg]:@[StickerImg,BeautyImg,MakeUpImg,SpecificImg];
        if (self.sdkLevelTYpe == 2) {
            arr = @[@"0",@"美颜",@"",@"0",@"0"];
            imgArr  =@[@"",BeautyImg,CameraImg,@"",@""];
